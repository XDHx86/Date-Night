...
useEffect(() => { updateUrl(); }, [updateUrl]); // Called on mount
```
...
2. **Replace the usage**:
   ...
   useEffect(() => { syncUrl(); }, [dependencies, syncUrl]);
   ```
...
*Document last updated: July 11, 2026*
*Related: TMDb integration (see previous version of this file for TMDb details)*
